      ...
      <div style={{ display: grid ? 'flex' : 'block', flexWrap: 'wrap' }}>
        ...
        <div style={empCard}>
          <img style={{
            ...
            borderTopRightRadius: '5px',
            borderTopLeftRadius: '5px'
          }} src="https://images.unsplash.com/photo-1705408685288-baa8572538ef?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
          <div style={{ textAlign: 'center' }}>
            <h2 >Azhar Hussain Khan</h2>
            <h4>Sql Server Devloper</h4>
          </div>
        </div>
